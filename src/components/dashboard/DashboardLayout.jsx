...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className={`flex min-h-screen relative overflow-hidden ${darkMode ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-900"}`}>
      ...
      <div className="absolute w-[500px] h-[500px] bg-purple-600 rounded-full blur-[150px] top-[15px] left-[-100px] opacity-30 animate-pulse-slow pointer-events-none -z-10"></div>
